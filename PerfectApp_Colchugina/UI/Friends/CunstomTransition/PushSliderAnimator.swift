...
final class PushSliderAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(
            ...
            animations: {
                source.view.transform = CGAffineTransform(rotationAngle: -.pi)
